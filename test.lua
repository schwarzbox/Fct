...
local function test()
    ...
    print('\nzarray')
    local zero_arr = fc.zarray()
    local pos_arr = fc.zarray(3)
    local neg_arr = fc.zarray(3,-1)
    fc.gkv(zero_arr)
    fc.gkv(pos_arr)
    fc.gkv(neg_arr)
    ...
    print('\nconcat')
    print(fc.concat(fc.cut('⌘utf8⌘utf8⌘utf8⌘', '⌘'),','))
    print(fc.concat(target,','))

    print('\nreverse')
    fc.gkv(fc.reverse(target))
    print(fc.concat(fc.reverse({0,4,2,1})))
    ...
    print('\nvalval')
    local mer_val_val = fc.valval({'lua','code'},fc.zarray(2))
    fc.gkv(mer_val_val)
